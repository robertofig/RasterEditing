...
#define USAGE_CODE "Usage: raster-cut.exe [output_raster] [cut_polygon] [input_raster ...]\n" \
...
"Example: raster-cut.exe path/to/output/out.tif path/to/polygon/cut-poly.shp img1.tif img2.tif img3.tif\n" \
"Output: GeoTIFF raster with all input files mosaicked and cut to the polygon's border.\n"
...
int main(int Argc, char** Argv)
{
    ...
    if (Shape.Type == ShpType_Polygon || Shape.Type == ShpType_PolygonM || Shape.Type == ShpType_PolygonZM)
    {
